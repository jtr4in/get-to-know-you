...
const cards = {
    ...
    'relationships': [
        ...
        { question: "What’s one thing you wish we did more often together?", challenge: "Plan an activity we can do together in 30 seconds." },
        ...
        { question: "If you could plan our perfect weekend, what would we do?", challenge: "Describe it in five words or fewer." },
        ...
        { question: "What’s one thing you think we’ve improved at as a couple?", challenge: "Act out that improvement." },
        { question: "What’s your favorite memory from our wedding day?", challenge: "Describe it with only hand gestures." },
        { question: "What’s the first thing you thought when you met me?", challenge: "Act out that thought without speaking." },
        { question: "What’s one thing you wish we had more time to do?", challenge: "Plan a quick 30-second solution to make time for it." },
        { question: "If we could learn a new skill together, what would it be?", challenge: "Pretend we're learning that skill together now." },
        { question: "What’s one thing you think we’re great at as a team?", challenge: "Show it by acting out a teamwork scenario." },
        { question: "What’s your favorite way we show affection to each other?", challenge: "Mimic that gesture without words." },
        ...
        { question: "What’s one thing you think brings us closer?", challenge: "Show it by miming a scenario where we grow closer." },
